 ...
 * @property integer $create_username
...
class Upload extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
            ...
            array('file', 'file', 'types'=>'jpg, gif, png', 'maxSize' => 2097152, 'wrongType'=>'รองรับเฉพาะ jpg, gif, png เท่านั้น'),
	...
	public function search()
	{
		...
		$criteria->compare('create_username',$this->create_username);
